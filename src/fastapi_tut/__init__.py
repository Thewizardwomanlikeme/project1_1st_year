...
# to start the server run this in the root folder i.e fastapi_tut - uv run uvicorn app.app:app --reload, cuz puthon wont be able to find app.py then in app.app:app. 
